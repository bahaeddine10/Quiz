export class quizRobotDev extends HTMLElement {
    ...
    connectedCallback(){
        ...
        const startBtn = this.getElementById('start-btn');
        const nextBtn = this.getElementById('next-btn');
...
const questionElement = this.getElementById('question');
const answerButtons = this.getElementById('answer-buttons');
...
function startGame(){
    ...
    const imgCard=this.createElement("div");
    ...
    const progressBar=this.getElementsByClassName("progress-bar")[0];
    setInterval(() => {
...
function selectAnswer(event){
    ...
    setStatusClass(this.body, correct)
